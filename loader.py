...
class DatasetFolder(object):
    ...
    def __init__(self, root, split_dir, split_type, parcel=True):
...
def get_dataloader(split, data, split_dir, meta=False, batch_size=None, sampler=None, sampler_infos=None, mapping=False):
    """
    Return a dataloader.
    ...
    """
    sets = DatasetFolder(data, split_dir, split)
